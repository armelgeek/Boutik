...
export const PasswordResetEmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Reset your Boutik password</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={messageText}>
              Someone (hopefully you!) has requested a password reset for your Boutik account. 
            ...
            <Section style={helpSection}>
              ...
              <Text style={helpText}>
                ...
                our support team is here to help. Contact us at support@boutik.com
              </Text>
            </Section>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              This password reset was requested for your Boutik account. If you didn&apos;t make this request, 
              please ignore this email or contact support if you have concerns.
            </Text>
            <Text style={footerContact}>
              Boutik Security Team | support@boutik.com
            </Text>
          </Section>
        </Container>
      </Body>
