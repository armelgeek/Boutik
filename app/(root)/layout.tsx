...
import SearchBar from "@/features/products/components/molecules/search-bar";
...
export default async function BaseLayout({ children }: RootLayoutProps) {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      <div className="bg-black px-4 py-3 font-medium text-white text-sm text-center">
                ...
                {session ? (
                  <div className="group relative">
                    ...
                    <div className="invisible group-hover:visible right-0 absolute bg-white opacity-0 group-hover:opacity-100 shadow-lg mt-2 py-1 rounded-md w-48 scale-95 group-hover:scale-100 origin-top-right transition-all duration-200 transform">
                      ...
                      <Link href="/orders" className="block hover:bg-gray-100 px-4 py-2 text-gray-700 text-sm">Orders</Link>
                      <Link href="/wishlist" className="block hover:bg-gray-100 px-4 py-2 text-gray-700 text-sm">Wishlist</Link>
